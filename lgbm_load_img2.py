...
categorical = ["user_id","region","city","parent_category_name","category_name","user_type","image_top_1","image_confidence"]
...
df_confidence.drop(["param_1","param_2","param_3", "description", "title"], axis=1,inplace=True)
...
lgsub.to_csv("lgsub-2.csv",index=True,header=True)
